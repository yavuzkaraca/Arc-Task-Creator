from src.tasks.attraction import generate_mock_attraction
from src.visualize import render_save_grid, render_grids_together, render_grid
from src.tasks.occlusion import generate_occlusion_reversal_rectangles
from src.util import get_output_path


def main():
    input_grid = generate_mock_attraction()
    render_grid(input_grid)
